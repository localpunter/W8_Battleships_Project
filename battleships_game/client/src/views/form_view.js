...
FormView.prototype.render = function (event) {
  ...
  const info = "Welcome to Battleship player 1, your mission is to hide your ships well in this grid so that you can emerge victorious from the rage of player 2. You have 5 ships to place and to do it you just have to click at the tiles"
