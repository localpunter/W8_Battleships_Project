...
GridView.prototype.render = function (event) {
  ...
  //info
  const info = `Unleash your wrath player 2, it's time to sink the enemy fleet. A simple click on the grid will be enough, but be sure to aim well, you only have ${this.guessesLeft} guesses. You have to sink 5 ships in total.`
